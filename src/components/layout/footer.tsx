      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-heading font-light text-white/70">
                Hijab
              </span>
            </div>
            <p className="text-sm text-white/60 leading-relaxed">
              Toko fashion muslim modern yang menghadirkan rangkaian koleksi
              eksklusif dengan kualitas bahan dan jahitan terbaik, dirancang
              khusus untuk memenuhi kebutuhan gaya hidup muslimah Indonesia.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a className="text-sm text-white/60 cursor-default">FAQ</a>
              </li>
              <li>
                <a className="text-sm text-white/60 cursor-default">
        ...
        <div className="border-t border-white/10 mt-8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/40">
            &copy; {new Date().getFullYear()} Elhasna Hijab. All rights
            reserved.
          </p>
